...
class BukuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.databuku.index', compact('bukus'));
    }
    ...
    public function create()
    {
        ...
        $title = 'Create | Data';
        return view('admin.databuku.create', compact('title', 'kategoris'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.databuku.edit', compact('title', 'buku', 'kategoris'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Redirect ke halaman daftar buku dengan pesan sukses
        return redirect()->route('databuku.index')->with('success', 'Buku berhasil diperbarui');
    }
